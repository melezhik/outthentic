...
C<--debug> - add debug info to test output, one of possible values : `0,1,2'. default value is `0'
...
C<--runner_debug> - add low level debug info to test output, mostly useful by me :) when debugging story runner
